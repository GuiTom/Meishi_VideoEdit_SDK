...
public class CameraSquareActivity extends AppCompatActivity {
    ...
    private void openCamera() {
        ...
        mMovieWriter.setTexureSize(preViewSize.width,preViewSize.height,true);
    ...
    public void addFilters(){
        ...
        if(gpuBeautyFilter!=null){
            ...
            if(gpuCommonFilter == null&&gpuBlendScreenFilter==null) {
                ...
                gpuBeautyFilter.setTexureSize(preViewSize.width,preViewSize.height,true);
            }
        }
        if(gpuCommonFilter!=null){
            ...
            gpuCommonFilter.setTexureSize(preViewSize.width,preViewSize.height,true);
        }
        if(gpuBlendScreenFilter!=null) {
            ...
            gpuBlendScreenFilter.setTexureSize(preViewSize.width,preViewSize.height,true);
        }
